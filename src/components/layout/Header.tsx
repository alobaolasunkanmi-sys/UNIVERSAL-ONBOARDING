...
import { Bell, Search, User, Key, LogOut, ShieldCheck, Building2 } from 'lucide-react';
...
export function Header({ onOpenAuthModal }: HeaderProps) {
  ...
  return (
    <header className="bg-white border-b border-slate-200/80 h-16 flex items-center justify-between px-6 sticky top-0 z-10 shadow-xs">
      {/* Search Input */}
      <div className="flex items-center w-80 sm:w-96 relative">
        <Search className="w-4 h-4 text-slate-400 absolute left-3" />
        <input 
          type="text" 
          placeholder="Search drivers, vehicles, businesses, or payments..." 
